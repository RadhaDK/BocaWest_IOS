...
class GetMemberInfo: NSObject, Mappable {
   ...
   // var interest: [ProfileInterest]?
    ...
    //ENGAGE0012516 -- Start
    var disableSendStatementTo : Int?
    var disableSendMagazineTo : Int?
    //ENGAGE0012516 -- End
    ...
    func mapping(map: Map) {
      ...
      showprimaryPhone <- map["ShowPrimaryPhone"]
       ...
       showAlternatePhone <- map["ShowAlternatePhone"]
        ...
        //Added by kiran V3.1 -- ENGAGE0012516 -- 
        //ENGAGE0012516 -- Start
        self.disableSendStatementTo <- map["DisableSendStatementTo"]
        self.disableSendMagazineTo <- map["DisableSendMagazineTo"]
        //ENGAGE0012516 -- End
