...
class Label: NSObject, Mappable  {
    ...
    func mapping(map: Map)
    {
        ...
        cONTACT_UPDATE_SUCCESS <- map["CONTACT_UPDATE_SUCCESS"]
        cONTACT_NAME_ALREADY_EXISTS <- map["CONTACT_NAME_ALREADY_EXISTS"]
        cONTACT_NUMBER_ALREADY_EXISTS <- map["CONTACT_NUMBER_ALREADY_EXISTS"]
        cONTACT_NAME_ALREADY_EXISTS_UPDATE <- map["CONTACT_NAME_ALREADY_EXISTS_UPDATE"]
        cONTACT_NUMBER_ALREADY_EXISTS_UPDATE <- map["CONTACT_NUMBER_ALREADY_EXISTS_UPDATE"]
        ...
        //Added by kiran V3.1 -- ENGAGE0012480 --
        //ENGAGE0012480 -- Start
        self.downloadAnnualDues <- map["DOWNLOADANNUALDUES"]
        //ENGAGE0012480 -- End
        ...
        //dues renewal
        DUES_RENEWAL_MEMBERSHIP_TYPE <- map["DUES_RENEWAL_MEMBERSHIP_TYPE"]
        DUES_RENEWAL_DURATION <- map["DUES_RENEWAL_DURATION"]
        DUES_RENEWAL_BILLING_FREQUENCY <- map["DUES_RENEWAL_BILLING_FREQUENCY"]
        DUES_RENEWAL_UPDATE_MEMBERSHIP_TYPE_TITLE <- map["DUES_RENEWAL_UPDATE_MEMBERSHIP_TYPE_TITLE"]
        DUES_RENEWAL_MEMBERSHIP_TYPE_HISTORY_TITLE <- map["DUES_RENEWAL_MEMBERSHIP_TYPE_HISTORY_TITLE"]
        OLD_MEMBERSHIP_TYPE_TITLE <- map["OLD_MEMBERSHIP_TYPE_TITLE"]
        NEW_MEMBERSHIP_TYPE_TITLE <- map["NEW_MEMBERSHIP_TYPE_TITLE"]
        REQUESTED_ON_TITLE <- map["REQUESTED_ON_TITLE"]
        STATUS_TYPE_TITLE <- map["STATUS_TYPE_TITLE"]
        COMMENT_TITLE <- map["COMMENT_TITLE"]
        CURRENT_MEM_TYPE_TITLE <- map["CURRENT_MEM_TYPE_TITLE"]
        NEW_MEM_TYPE_TITLE <- map["NEW_MEM_TYPE_TITLE"]
        DUES_RENEWAL_BILLING_FREQUENCY_HISTORY_TITLE <- map["DUES_RENEWAL_BILLING_FREQUENCY_HISTORY_TITLE"]
        DUES_RENEWAL_MEMBERSHIP_TYPE_UPDATE_REQUEST_MESSAGE <- map["DUES_RENEWAL_MEMBERSHIP_TYPE_UPDATE_REQUEST_MESSAGE"]
        DUES_RENEWAL_MEMBERSHIP_TYPE_CANCELLED_MESSAGE <- map["DUES_RENEWAL_MEMBERSHIP_TYPE_CANCELLED_MESSAGE"]
        AUTO_APPROVED_MESSAGE <- map["AUTO_APPROVED_MESSAGE"]
        DUES_RENEWAL_BILLING_FREQUENCY_UPDATE_REQUEST_MESSAGE <- map["DUES_RENEWAL_BILLING_FREQUENCY_UPDATE_REQUEST_MESSAGE"]
        DUES_RENEWAL_CANCEL_PENDING_REQUEST_MESSAGE <- map["DUES_RENEWAL_CANCEL_PENDING_REQUEST_MESSAGE"]
        DUES_RENEWAL_UPDATE_BILLING_FREQUENCY_TITLE <- map["DUES_RENEWAL_UPDATE_BILLING_FREQUENCY_TITLE"]
        PLEASE_SELECT_TYPE_MESSAGE <- map["PLEASE_SELECT_TYPE_MESSAGE"]
        DUES_RENEWAL_BILLING_FREQUENCY_CANCELLED_MESSAGE <- map["DUES_RENEWAL_BILLING_FREQUENCY_CANCELLED_MESSAGE"]
        ...
        DINING_FCFS_TITLE <- map["DINING_FCFS_TITLE"]
        DINING_FCFS_NEXT_DATE <- map["DINING_FCFS_NEXT_DATE"]
        DINING_FCFS_SELECTED_DATE <- map["DINING_FCFS_SELECTED_DATE"]
        DINING_FCFS_ANYRESTAURANT <- map["DINING_FCFS_ANYRESTAURANT"]
        DINING_FCFS_DININGINFOONE <- map["DINING_FCFS_DININGINFOONE"]
        DINING_FCFS_DININGDATETIME <- map["DINING_FCFS_DININGDATETIME"]
        DINING_FCFS_ELECTEDRESTAURANT <- map["DINING_FCFS_ELECTEDRESTAURANT"]
        DINING_FCFS_DININGINFOTWO <- map["DINING_FCFS_DININGINFOTWO"]
        DINING_FCFS_DINING_OTHERDATE <- map["DINING_FCFS_DINING_OTHERDATE"]
        DINING_FCFS_DINING_RESTAURANT <- map["DINING_FCFS_DINING_RESTAURANT"]
        DINING_FCFS_DININGREQUEST_TIME <- map["DINING_FCFS_DININGREQUEST_TIME"]
        DINING_FCFS_DINING_CANCELTEXT <- map["DINING_FCFS_DINING_CANCELTEXT"]
