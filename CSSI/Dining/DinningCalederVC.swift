//
//  DinningCalederVC.swift
//  CSSI
//
//  Created by Aks on 18/10/22.
...
class DinningCalederVC: UIViewController,UISearchBarDelegate, DTCalendarViewDelegate {
...
//        navigationItem.rightBarButtonItem = homeBarButton
    ...
    @objc func segmentSelected(sender:ScrollableSegmentedControl)
    {
        ...
        else if(sender.selectedSegmentIndex == 0)
        {
            ...
            let previousStatementVC = UIStoryboard.init(name: "MemberApp", bundle: .main).instantiateViewController(withIdentifier: "GolfCalendarMYTabVC") as? GolfCalendarMYTabVC
            previousStatementVC?.title =  self.appDelegate.masterLabeling.tAB_PREVIOUS
            lblUpcomingEvent.isHidden = true
            topLabelHeight.constant = -58
        ...
        else if(sender.selectedSegmentIndex == 1)
        {
            ...
            let previousStatementVC =  UIStoryboard.init(name: "MemberApp", bundle: .main).instantiateViewController(withIdentifier: "EventsVC") as? EventsVC
