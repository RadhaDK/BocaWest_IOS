...
class GolfRequestTeeTimeVC: UIViewController, UITableViewDelegate, UITableViewDataSource,  UICollectionViewDelegate, UICollectionViewDataSource, FSCalendarDelegate, FSCalendarDataSource, FSCalendarDelegateAppearance, guestViewControllerDelegate, RequestCellDelegate,MemberViewControllerDelegate, RegistrationCell, ModifyRegistration, closeModalView, UIActionSheetDelegate, UITextFieldDelegate,closeUpdateSuccesPopup {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        if (tableView == modifyTableview){
            ...
            if arrTeeTimeDetails[0].buttonTextValue == "3" || arrTeeTimeDetails[0].buttonTextValue == "4" || self.arrTeeTimeDetails[0].buttonTextValue == "5"{
                headerView.heightBWGroup.constant = 89
    ...
    func tableView(_ tableView: UITableView, heightForHeaderInSection section: Int) -> CGFloat {
        if tableView == addNewPopoverTableView {
            ...
            if arrTeeTimeDetails.count == 0 {
                ...
                if arrTeeTimeDetails[0].buttonTextValue == "3" || arrTeeTimeDetails[0].buttonTextValue == "4" || self.arrTeeTimeDetails[0].buttonTextValue == "5"{
                    return 260 + (section < (self.arrTeeTimeDetails.first?.groupDetails?.count ?? 0) ? (self.arrTeeTimeDetails.first?.groupDetails?[section].buttonTextValue == "3" ? 38 : 0) : 0)
