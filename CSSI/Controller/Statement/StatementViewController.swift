...
//        self.btnCreditBook.clipsToBounds = true
        ...
        //ENGAGE0012480 -- Start
        self.DueStatementsBtn.setStyle(style: .outlined, type: .primary)
...
//        self.navigationItem.rightBarButtonItem?.tintColor = APPColor.viewBgColor.viewbg
        ...
        //Modified by kiran V3.1 -- ENGAGE0012480 --
        //ENGAGE0012480 -- Start
    ...
    //Added by kiran V3.1 -- ENGAGE0012480 --
    //ENGAGE0012480 -- Start
    @IBAction func downloadDueStatementsClicked(_ sender: UIButton)
    {
        self.appDelegate.downloadMonth = ""
        NotificationCenter.default.post(name: NSNotification.Name("downloadData"), object: nil, userInfo: nil)
        ...
        //Added by kiran V3.1 -- ENGAGE0012480 --
        //ENGAGE0012480 -- Start
        restarantpdfDetailsVC.isDueStatement = 1
        //ENGAGE0012480 -- End
        self.navigationController?.pushViewController(restarantpdfDetailsVC, animated: true)
    }
    //ENGAGE0012480 -- End
...
//Added by kiran V3.1 -- ENGAGE0012480 --
//ENGAGE0012480 -- Start
extension StatementViewController : CurrentStatementViewControllerDelegate
{
    func showDueStatementsBtn(flag: Bool)
    {
        self.DueStatementsBtn.isHidden = !flag
    }
}
//ENGAGE0012480 -- End
