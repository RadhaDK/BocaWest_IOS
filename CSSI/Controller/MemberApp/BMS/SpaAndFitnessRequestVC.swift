    ...
    @IBAction func submitClickAction(_ sender: UIButton)
    {
        ...
        case .request,.modify:
            ...
            case .fitnessAndSpa:
                ...
                case .view:
                    //Modified by kiran V3.1 -- ENGAGE0012550 -- Showing wrong message for roles and privilage. Change the message from role_Validation2 to role_Validation1
                    //ENGAGE0012550 -- Start
...
extension SpaAndFitnessRequestVC : UICollectionViewDelegate , UICollectionViewDataSource , UICollectionViewDelegateFlowLayout
{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.lblTime.textColor = hexStringToUIColor(hex: colorHex)
        cell.lblPeriod.textColor = hexStringToUIColor(hex: colorHex)
        return cell
    }
