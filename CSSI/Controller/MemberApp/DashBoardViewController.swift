...
//        self.masterListData()
        //Added by kiran V3.1 -- ENGAGE0012571 -- This fixes the issue - Share screen is not displayed properly, when member open share screen for Dining and Tennis Reservations after navigating form “Golf/Tennis/Dining & Fitness & Spa” My Calendar screen.
        //ENGAGE0012571 -- Start
            ...
            APIHandler.sharedInstance.getDashBoardData(paramaterDict: paramaterDict , onSuccess: { eventList in
                if(eventList.responseCode == InternetMessge.kSuccess)
                {
                    ...
                    case .notAllowed :
                        ...
                        let alertController = UIAlertController(title: self.appDelegate.masterLabeling.mEMBER_DEACTIVATED ?? "Member Deactivated", message: self.appDelegate.masterLabeling.dEACTIVATED_LOGOUT ?? "Your account is Inactive, please contact Communications@bocawestcc.org", preferredStyle: .alert)
                    ...
                    let versionFromServer = appVersionFromServer
                        ...
                        if (currentAppVersion < versionFromServer) {
                            ...
                            let okAction = UIAlertAction(title: self.appDelegate.masterLabeling.uPDATE, style: UIAlertActionStyle.default) {
                                UIAlertAction in
                                guard let url = URL(string: "https://itunes.apple.com/us/app/boca-west-country-club/id1478595289") else { return }
...
//    }
    ...
    @IBAction func twitterClicked(_ sender: Any) {
        ...
        let twitterUrl = URL(string: "twitter://user?screen_name=BocaWestCC")
    ...
    @IBAction func pinterestClicked(_ sender: Any) {
        ...
        let pinterestUrl = URL(string: "pinterest://user/BocaWestCC")
    ...
    @IBAction func fbClicked(_ sender: Any) {
        ...
        let fbUrl = URL(string: "fb://profile/124947047553607")
    ...
    @IBAction func instClicked(_ sender: Any) {
        let instagramHooks = "instagram://user?username=bocawestcc"
