...
class EventCustomTableViewCell: UITableViewCell {
   ...
   // @IBOutlet weak var statusWidth: NSLayoutConstraint!
    ...
    override func awakeFromNib() {
        ...
        //Modified by kiran V3.1 -- ENGAGE0012367 -- Commented selectedSegment comparision as its cassing an issue where Flyer image is not loading sometimes when member click any events image in the events listing screen.
        //ENGAGE0012367 -- Start
