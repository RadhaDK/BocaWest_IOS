...
class ForgotVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //ENGAGE0011688 -- Start
        self.lblForgotEmailText.text = self.appDelegate.masterLabeling.if_you_donot_remember_your_email ?? "If you do not remember which username you registered with our system, please contact communications@bocawestcc.org."
        //ENGAGE0011688 -- End
