...
class ProfileViewOnlyVC: UIViewController {
    ...
    //Commented by kiran V3.2 -- ENGAGE0012634 -- Redid the layout and removed the dependency with this constraint. did this as the old layout was not supporting the hiding of one view in the screen.
    //ENGAGE0012634 -- Start
...
//                }
                ...
                //Added by kiran V3.2 -- ENGAGE0012634 -- Hiding the anniversary view.
                //ENGAGE0012634 -- Start
                self.viewAnniversary.isHidden = (arrgetMemberInfo.memberLinkedMemberNumber != "00")
                //ENGAGE0012634 -- End
