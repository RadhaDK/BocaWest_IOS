...
public struct ButtonStyles {
  ...
  var tintColor: UIColor = APPColor.solidbgColor.solidNewbg
  ...
  public static let deselect = ButtonStyles()
    public static let select = ButtonStyles(backgroundColor: APPColor.navigationColor.solidNewbg,tintColor: APPColor.navigationColor.tintBGColor )
