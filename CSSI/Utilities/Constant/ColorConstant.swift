...
struct APPColor {
    ...
    struct viewNews {
        ...
        static var backButtonColor = hexStringToUIColor(hex: "F06E44")     
    ...
    struct navigationColor {
        ...
        static var barTintColor = hexStringToUIColor(hex: "695B5E")
        static var barbackgroundcolor = hexStringToUIColor(hex: "695B5E")
    ...
    struct loginBackgroundButtonColor {
        static var loginBtnBGColor = hexStringToUIColor(hex: "f06c42")
    ...
    struct textColor
    {
        ...
        static let pickleBallHeaderColor : UIColor = MainColours.primary1
        //GATHER0000923 -- End
    }
    ...
    {
        //Brown
        static let primary1 : UIColor = hexStringToUIColor(hex: "695B5E")
        //orange
    ...
    struct ButtonColors
    {
        static let primary : UIColor = MainColours.primary2
        static let primaryBorder : UIColor = hexStringToUIColor(hex: "#F06C42")
        
        static let secondary : UIColor = hexStringToUIColor(hex: "#40B2E6")
        static let secondaryBorder : UIColor = hexStringToUIColor(hex: "#40B2E6")
    ...
    struct OtherColors
    {
        ...
        //Added by kiran V3.1 -- ENGAGE0012516 --
        //ENGAGE0012516 -- Start
        static let disableColor : UIColor = hexStringToUIColor(hex: "#F6F6F6")
        //ENGAGE0012516 -- End
    }
    ...
    struct DropDownColors
    {
        ...
        //ENGAGE0011784 -- End
        static let textColor : UIColor = MainColours.primary1
    }
    //GATHER0000923 -- End
...
struct APPColorDarkMode
{
    ...
    struct viewNews
    {
        ...
        static let backButtonColor = hexStringToUIColor(hex: "F06E44")
    }
    ...
    struct navigationColor
    {
        ...
        static let barTintColor = hexStringToUIColor(hex: "695B5E")
    ...
    struct loginBackgroundButtonColor
    {
        static let loginBtnBGColor = hexStringToUIColor(hex: "f06c42")
