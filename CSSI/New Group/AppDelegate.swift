...
//        UINavigationBar.appearance().tintColor = APPColor.viewBgColor.viewbg
        ...
        //Added by kiran V3.1 -- ENGAGE0012558 -- Setting default style as light. To fix the issue in app where background is turning to black in dark mode.
        //ENGAGE0012558 -- Start
        ...
        if (Network.reachability?.isReachable) == true{
            ...
            APIHandler.sharedInstance.getAppVersion(paramater: paramaterDict, onSuccess: { (response) in
                ...
                if response.memberStatus == 0{
                    ...
                    let alertController = UIAlertController(title: self.masterLabeling.mEMBER_DEACTIVATED ?? "Member Deactivated", message: self.masterLabeling.dEACTIVATED_LOGOUT ?? "Your account is Inactive, please contact Communications@bocawestcc.org", preferredStyle: .alert)
