...
- (void)commonInit
{
    ...
    for (int i = 0; i < 7; i++) {
        ...
        if(i == 0 || i == 6){
            weekdayLabel.textColor = [UIColor colorWithRed:(244/255.f) green:(125/255.f) blue:(76/255.f) alpha:1.0];;
            
        }
        else{
            weekdayLabel.textColor = [UIColor colorWithRed:(105/255.f) green:(91/255.f) blue:(94/255.f) alpha:1.0];
        }
